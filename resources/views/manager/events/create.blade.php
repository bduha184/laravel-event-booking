                    ...
                    <div class="max-w-2xl py-4 mx-auto">
                        ...
                        <form method="POST" action="{{ route('events.store') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <x-textarea row="3" id="information" name="information" class="block mt-1 w-full">{{old('event_name')}} </x-textarea>
                            </div>
